...
#Função para voltar ao menu com qualquer tecla
def voltar_ao_menu_principal():
    input('\nDigite uma tecla para voltar ao menu ')
    main()

#Função para erros no menu
def opcao_invalida():
    print('Opção inválida!\n')
    voltar_ao_menu_principal()

#Função para quando limpar com cls, aparecer a opção do menu.
